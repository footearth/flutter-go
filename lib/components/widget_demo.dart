...
class _WidgetDemoState extends State<WidgetDemo> {
  ...
  ;
  CollectionControlModel _collectionControl =
    CollectionControlModel()
  ;
  ...
  Widget build(BuildContext context) {
    ...
    , bottomNavigationBar:
        (widget.bottomNaviBar is Widget)
